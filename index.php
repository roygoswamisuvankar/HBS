                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="#">2 stars</a>
                        ...
                        <button style="background-color: red; color: white; border: none;"><a href="customer/login.php" style="color:white;">Book Now</a> </button>                    
                    </ul>
                </div>
            </div>
        </nav>
...
l be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters,</p>
            ...
            <div class="overlay">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <h3>Find us</h3>
                            <p>Chuchurah Hooghly<br>
                                Besides Ganga, NY 10014, INDIA<br>
                                +91 9748836183<br>
                                +91 7003443278<br>
                                fivehotel@gmail.com
                            </p>
        ...
        <div class="copyright noto-font-family">
            <p>© 2022 All Rights Reserved. Design by <a href="https://html.design/">Srgoswami</a></p>
        </div>
